...
public class TraceInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4664837363669471021L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TraceInfo\",\"namespace\":\"com.pickme.events.trip\",\"fields\":[{\"name\":\"trace_id\",\"type\":{\"type\":\"record\",\"name\":\"TraceId\",\"fields\":[{\"name\":\"high\",\"type\":\"long\",\"default\":0},{\"name\":\"low\",\"type\":\"long\",\"default\":0}]}},{\"name\":\"span_id\",\"type\":\"long\",\"default\":0},{\"name\":\"parent_id\",\"type\":\"long\",\"default\":0},{\"name\":\"sampled\",\"type\":\"boolean\",\"default\":false}]}");
  ...
  @Deprecated public com.pickme.events.trip.TraceId trace_id;
   ...
   */
  public TraceInfo(com.pickme.events.trip.TraceId trace_id, java.lang.Long span_id, java.lang.Long parent_id, java.lang.Boolean sampled) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: trace_id = (com.pickme.events.trip.TraceId)value$; break;
   ...
   */
  public com.pickme.events.trip.TraceId getTraceId() {
    return trace_id;
  }
   ...
   */
  public void setTraceId(com.pickme.events.trip.TraceId value) {
    this.trace_id = value;
  }
   ...
   */
  public static com.pickme.events.trip.TraceInfo.Builder newBuilder() {
    return new com.pickme.events.trip.TraceInfo.Builder();
  }
   ...
   * @return A new TraceInfo RecordBuilder
   */
  public static com.pickme.events.trip.TraceInfo.Builder newBuilder(com.pickme.events.trip.TraceInfo.Builder other) {
    return new com.pickme.events.trip.TraceInfo.Builder(other);
  }
   ...
   * @return A new TraceInfo RecordBuilder
   */
  public static com.pickme.events.trip.TraceInfo.Builder newBuilder(com.pickme.events.trip.TraceInfo other) {
    return new com.pickme.events.trip.TraceInfo.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TraceInfo>
    ...
    private com.pickme.events.trip.TraceId trace_id;
    private com.pickme.events.trip.TraceId.Builder trace_idBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pickme.events.trip.TraceInfo.Builder other) {
      super(other);
      ...
      if (other.hasTraceIdBuilder()) {
        this.trace_idBuilder = com.pickme.events.trip.TraceId.newBuilder(other.getTraceIdBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pickme.events.trip.TraceInfo other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.trace_id)) {
        this.trace_id = data().deepCopy(fields()[0].schema(), other.trace_id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TraceInfo.Builder setTraceId(com.pickme.events.trip.TraceId value) {
     ...
     * @return This builder.
     */
    public com.pickme.events.trip.TraceId.Builder getTraceIdBuilder() {
      if (trace_idBuilder == null) {
        if (hasTraceId()) {
          setTraceIdBuilder(com.pickme.events.trip.TraceId.newBuilder(trace_id));
        } else {
          setTraceIdBuilder(com.pickme.events.trip.TraceId.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.pickme.events.trip.TraceInfo.Builder setTraceIdBuilder(com.pickme.events.trip.TraceId.Builder value) {
      clearTraceId();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TraceInfo.Builder clearTraceId() {
      trace_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TraceInfo.Builder setSpanId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TraceInfo.Builder clearSpanId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TraceInfo.Builder setParentId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TraceInfo.Builder clearParentId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TraceInfo.Builder setSampled(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TraceInfo.Builder clearSampled() {
    ...
    public TraceInfo build() {
      try {
        ...
        if (trace_idBuilder != null) {
          ...
          record.trace_id = fieldSetFlags()[0] ? this.trace_id : (com.pickme.events.trip.TraceId) defaultValue(fields()[0]);
        }
