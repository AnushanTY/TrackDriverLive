...
public class TripCreated extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<TripCreated> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<TripCreated>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this TripCreated to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a TripCreated from a ByteBuffer. */
  public static TripCreated fromByteBuffer(
  ...
  @Deprecated public com.pickme.events.trip.trip_created.Body body;
   ...
   */
  public TripCreated(java.lang.CharSequence id, java.lang.CharSequence type, com.pickme.events.trip.trip_created.Body body, java.lang.Long created_at, java.lang.Long expiry, java.lang.Integer version, com.pickme.events.trip.TraceInfo trace_info) {
    this.id = id;
    this.type = type;
    this.body = body;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: body = (com.pickme.events.trip.trip_created.Body)value$; break;
   ...
   */
  public com.pickme.events.trip.trip_created.Body getBody() {
    return body;
  }
   ...
   * @param value the value to set.
   */
  public void setBody(com.pickme.events.trip.trip_created.Body value) {
    this.body = value;
  }
  ...
  /**
   * Creates a new TripCreated RecordBuilder.
   * @return A new TripCreated RecordBuilder
   */
  public static com.pickme.events.trip.TripCreated.Builder newBuilder() {
    return new com.pickme.events.trip.TripCreated.Builder();
  }

  /**
   * Creates a new TripCreated RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new TripCreated RecordBuilder
   */
  public static com.pickme.events.trip.TripCreated.Builder newBuilder(com.pickme.events.trip.TripCreated.Builder other) {
    return new com.pickme.events.trip.TripCreated.Builder(other);
  }

  /**
   * Creates a new TripCreated RecordBuilder by copying an existing TripCreated instance.
   * @param other The existing instance to copy.
   * @return A new TripCreated RecordBuilder
   */
  public static com.pickme.events.trip.TripCreated.Builder newBuilder(com.pickme.events.trip.TripCreated other) {
    return new com.pickme.events.trip.TripCreated.Builder(other);
  }

  /**
   * RecordBuilder for TripCreated instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TripCreated>
    implements org.apache.avro.data.RecordBuilder<TripCreated> {

    private java.lang.CharSequence id;
    private java.lang.CharSequence type;
    private com.pickme.events.trip.trip_created.Body body;
    private com.pickme.events.trip.trip_created.Body.Builder bodyBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pickme.events.trip.TripCreated.Builder other) {
      super(other);
      ...
      if (other.hasBodyBuilder()) {
        this.bodyBuilder = com.pickme.events.trip.trip_created.Body.newBuilder(other.getBodyBuilder());
      }
    ...
    /**
     * Creates a Builder by copying an existing TripCreated instance
     * @param other The existing instance to copy.
     */
    private Builder(com.pickme.events.trip.TripCreated other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder setBody(com.pickme.events.trip.trip_created.Body value) {
     ...
     * @return This builder.
     */
    public com.pickme.events.trip.trip_created.Body.Builder getBodyBuilder() {
      if (bodyBuilder == null) {
        if (hasBody()) {
          setBodyBuilder(com.pickme.events.trip.trip_created.Body.newBuilder(body));
        } else {
          setBodyBuilder(com.pickme.events.trip.trip_created.Body.newBuilder());
        }
      }
      return bodyBuilder;
    }
     ...
     * @return This builder.
     */
    public com.pickme.events.trip.TripCreated.Builder setBodyBuilder(com.pickme.events.trip.trip_created.Body.Builder value) {
      clearBody();
      bodyBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder clearBody() {
      body = null;
      bodyBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder setCreatedAt(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder setExpiry(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder clearExpiry() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder setVersion(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder clearVersion() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder setTraceInfo(com.pickme.events.trip.TraceInfo value) {
     ...
     * @return This builder.
     */
    public com.pickme.events.trip.TripCreated.Builder setTraceInfoBuilder(com.pickme.events.trip.TraceInfo.Builder value) {
      clearTraceInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.TripCreated.Builder clearTraceInfo() {
      trace_info = null;
    ...
    public TripCreated build() {
      try {
        TripCreated record = new TripCreated();
        ...
        if (bodyBuilder != null) {
          ...
          record.body = fieldSetFlags()[2] ? this.body : (com.pickme.events.trip.trip_created.Body) defaultValue(fields()[2]);
        }
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<TripCreated>
    WRITER$ = (org.apache.avro.io.DatumWriter<TripCreated>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<TripCreated>
    READER$ = (org.apache.avro.io.DatumReader<TripCreated>)MODEL$.createDatumReader(SCHEMA$);
