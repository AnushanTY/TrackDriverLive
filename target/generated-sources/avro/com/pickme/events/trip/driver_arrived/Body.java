 ...
 */
package com.pickme.events.trip.driver_arrived;
...
public class Body extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4664617088911307842L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Body\",\"namespace\":\"com.pickme.events.trip.driver_arrived\",\"fields\":[{\"name\":\"trip_id\",\"type\":\"int\"},{\"name\":\"driver_id\",\"type\":\"int\"},{\"name\":\"location\",\"type\":{\"type\":\"record\",\"name\":\"Location\",\"fields\":[{\"name\":\"address\",\"type\":\"string\"},{\"name\":\"lat\",\"type\":\"float\"},{\"name\":\"lng\",\"type\":\"float\"}]}}]}");
  ...
  @Deprecated public com.pickme.events.trip.driver_arrived.Location location;
   ...
   */
  public Body(java.lang.Integer trip_id, java.lang.Integer driver_id, com.pickme.events.trip.driver_arrived.Location location) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: location = (com.pickme.events.trip.driver_arrived.Location)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.pickme.events.trip.driver_arrived.Location getLocation() {
    return location;
  }
   ...
   * @param value the value to set.
   */
  public void setLocation(com.pickme.events.trip.driver_arrived.Location value) {
    this.location = value;
  }
   ...
   */
  public static com.pickme.events.trip.driver_arrived.Body.Builder newBuilder() {
    return new com.pickme.events.trip.driver_arrived.Body.Builder();
  }
   ...
   * @return A new Body RecordBuilder
   */
  public static com.pickme.events.trip.driver_arrived.Body.Builder newBuilder(com.pickme.events.trip.driver_arrived.Body.Builder other) {
    return new com.pickme.events.trip.driver_arrived.Body.Builder(other);
  }
   ...
   * @return A new Body RecordBuilder
   */
  public static com.pickme.events.trip.driver_arrived.Body.Builder newBuilder(com.pickme.events.trip.driver_arrived.Body other) {
    return new com.pickme.events.trip.driver_arrived.Body.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Body>
    ...
    private com.pickme.events.trip.driver_arrived.Location location;
    private com.pickme.events.trip.driver_arrived.Location.Builder locationBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pickme.events.trip.driver_arrived.Body.Builder other) {
      super(other);
      ...
      if (other.hasLocationBuilder()) {
        this.locationBuilder = com.pickme.events.trip.driver_arrived.Location.newBuilder(other.getLocationBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pickme.events.trip.driver_arrived.Body other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.trip_id)) {
        this.trip_id = data().deepCopy(fields()[0].schema(), other.trip_id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.driver_arrived.Body.Builder setTripId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.driver_arrived.Body.Builder clearTripId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.driver_arrived.Body.Builder setDriverId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.driver_arrived.Body.Builder clearDriverId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.driver_arrived.Body.Builder setLocation(com.pickme.events.trip.driver_arrived.Location value) {
     ...
     * @return This builder.
     */
    public com.pickme.events.trip.driver_arrived.Location.Builder getLocationBuilder() {
      if (locationBuilder == null) {
        if (hasLocation()) {
          setLocationBuilder(com.pickme.events.trip.driver_arrived.Location.newBuilder(location));
        } else {
          setLocationBuilder(com.pickme.events.trip.driver_arrived.Location.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.pickme.events.trip.driver_arrived.Body.Builder setLocationBuilder(com.pickme.events.trip.driver_arrived.Location.Builder value) {
      clearLocation();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.driver_arrived.Body.Builder clearLocation() {
      location = null;
    ...
    public Body build() {
      try {
        ...
        if (locationBuilder != null) {
          ...
          record.location = fieldSetFlags()[2] ? this.location : (com.pickme.events.trip.driver_arrived.Location) defaultValue(fields()[2]);
        }
        return record;
