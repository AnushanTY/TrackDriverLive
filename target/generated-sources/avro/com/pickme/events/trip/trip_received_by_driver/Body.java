 ...
 */
package com.pickme.events.trip.trip_received_by_driver;
...
public class Body extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5825132912312100208L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Body\",\"namespace\":\"com.pickme.events.trip.trip_received_by_driver\",\"fields\":[{\"name\":\"trip_id\",\"type\":\"int\"},{\"name\":\"driver_id\",\"type\":\"int\"}]}");
   ...
   */
  public static com.pickme.events.trip.trip_received_by_driver.Body.Builder newBuilder() {
    return new com.pickme.events.trip.trip_received_by_driver.Body.Builder();
  }
   ...
   * @return A new Body RecordBuilder
   */
  public static com.pickme.events.trip.trip_received_by_driver.Body.Builder newBuilder(com.pickme.events.trip.trip_received_by_driver.Body.Builder other) {
    return new com.pickme.events.trip.trip_received_by_driver.Body.Builder(other);
  }
   ...
   * @return A new Body RecordBuilder
   */
  public static com.pickme.events.trip.trip_received_by_driver.Body.Builder newBuilder(com.pickme.events.trip.trip_received_by_driver.Body other) {
    return new com.pickme.events.trip.trip_received_by_driver.Body.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Body>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pickme.events.trip.trip_received_by_driver.Body.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pickme.events.trip.trip_received_by_driver.Body other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.trip_id)) {
        this.trip_id = data().deepCopy(fields()[0].schema(), other.trip_id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_received_by_driver.Body.Builder setTripId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_received_by_driver.Body.Builder clearTripId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_received_by_driver.Body.Builder setDriverId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_received_by_driver.Body.Builder clearDriverId() {
