...
public class location extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4872516116596044455L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"location\",\"namespace\":\"com.pickme.events.trip.trip_accepted\",\"fields\":[{\"name\":\"address\",\"type\":\"string\"},{\"name\":\"lat\",\"type\":\"float\"},{\"name\":\"lng\",\"type\":\"float\"}]}");
   ...
   */
  public static com.pickme.events.trip.trip_accepted.location.Builder newBuilder() {
    return new com.pickme.events.trip.trip_accepted.location.Builder();
  }
   ...
   * @return A new location RecordBuilder
   */
  public static com.pickme.events.trip.trip_accepted.location.Builder newBuilder(com.pickme.events.trip.trip_accepted.location.Builder other) {
    return new com.pickme.events.trip.trip_accepted.location.Builder(other);
  }
   ...
   * @return A new location RecordBuilder
   */
  public static com.pickme.events.trip.trip_accepted.location.Builder newBuilder(com.pickme.events.trip.trip_accepted.location other) {
    return new com.pickme.events.trip.trip_accepted.location.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<location>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pickme.events.trip.trip_accepted.location.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pickme.events.trip.trip_accepted.location other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_accepted.location.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_accepted.location.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_accepted.location.Builder setLat(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_accepted.location.Builder clearLat() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_accepted.location.Builder setLng(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_accepted.location.Builder clearLng() {
