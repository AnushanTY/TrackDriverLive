...
public class Location extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2527552286011184159L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Location\",\"namespace\":\"com.pickme.events.trip.trip_created\",\"fields\":[{\"name\":\"address\",\"type\":\"string\"},{\"name\":\"lat\",\"type\":\"float\"},{\"name\":\"lng\",\"type\":\"float\"}]}");
   ...
   */
  public static com.pickme.events.trip.trip_created.Location.Builder newBuilder() {
    return new com.pickme.events.trip.trip_created.Location.Builder();
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static com.pickme.events.trip.trip_created.Location.Builder newBuilder(com.pickme.events.trip.trip_created.Location.Builder other) {
    return new com.pickme.events.trip.trip_created.Location.Builder(other);
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static com.pickme.events.trip.trip_created.Location.Builder newBuilder(com.pickme.events.trip.trip_created.Location other) {
    return new com.pickme.events.trip.trip_created.Location.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Location>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pickme.events.trip.trip_created.Location.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pickme.events.trip.trip_created.Location other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_created.Location.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_created.Location.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_created.Location.Builder setLat(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_created.Location.Builder clearLat() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_created.Location.Builder setLng(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.trip.trip_created.Location.Builder clearLng() {
