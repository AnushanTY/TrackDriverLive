...
public class TraceId extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6408014958992674431L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TraceId\",\"namespace\":\"com.pickme.events.driver\",\"fields\":[{\"name\":\"high\",\"type\":\"long\",\"default\":0},{\"name\":\"low\",\"type\":\"long\",\"default\":0}]}");
   ...
   */
  public static com.pickme.events.driver.TraceId.Builder newBuilder() {
    return new com.pickme.events.driver.TraceId.Builder();
  }
   ...
   * @return A new TraceId RecordBuilder
   */
  public static com.pickme.events.driver.TraceId.Builder newBuilder(com.pickme.events.driver.TraceId.Builder other) {
    return new com.pickme.events.driver.TraceId.Builder(other);
  }
   ...
   * @return A new TraceId RecordBuilder
   */
  public static com.pickme.events.driver.TraceId.Builder newBuilder(com.pickme.events.driver.TraceId other) {
    return new com.pickme.events.driver.TraceId.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TraceId>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pickme.events.driver.TraceId.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pickme.events.driver.TraceId other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.high)) {
        this.high = data().deepCopy(fields()[0].schema(), other.high);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.driver.TraceId.Builder setHigh(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.driver.TraceId.Builder clearHigh() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.driver.TraceId.Builder setLow(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.driver.TraceId.Builder clearLow() {
