...
public class Body extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -31689038736702928L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Body\",\"namespace\":\"com.pickme.events.driver.driver_location_changed\",\"fields\":[{\"name\":\"driver_id\",\"type\":\"int\"},{\"name\":\"location\",\"type\":{\"type\":\"record\",\"name\":\"Location\",\"fields\":[{\"name\":\"lat\",\"type\":\"float\"},{\"name\":\"lng\",\"type\":\"float\"},{\"name\":\"accuracy\",\"type\":\"float\"},{\"name\":\"speed\",\"type\":\"float\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"bearing\",\"type\":\"float\",\"default\":0}]}}]}");
  ...
  @Deprecated public com.pickme.events.driver.driver_location_changed.Location location;
   ...
   */
  public Body(java.lang.Integer driver_id, com.pickme.events.driver.driver_location_changed.Location location) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: location = (com.pickme.events.driver.driver_location_changed.Location)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.pickme.events.driver.driver_location_changed.Location getLocation() {
    return location;
  }
   ...
   * @param value the value to set.
   */
  public void setLocation(com.pickme.events.driver.driver_location_changed.Location value) {
    this.location = value;
  }
   ...
   */
  public static com.pickme.events.driver.driver_location_changed.Body.Builder newBuilder() {
    return new com.pickme.events.driver.driver_location_changed.Body.Builder();
  }
   ...
   * @return A new Body RecordBuilder
   */
  public static com.pickme.events.driver.driver_location_changed.Body.Builder newBuilder(com.pickme.events.driver.driver_location_changed.Body.Builder other) {
    return new com.pickme.events.driver.driver_location_changed.Body.Builder(other);
  }
   ...
   * @return A new Body RecordBuilder
   */
  public static com.pickme.events.driver.driver_location_changed.Body.Builder newBuilder(com.pickme.events.driver.driver_location_changed.Body other) {
    return new com.pickme.events.driver.driver_location_changed.Body.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Body>
    ...
    private com.pickme.events.driver.driver_location_changed.Location location;
    private com.pickme.events.driver.driver_location_changed.Location.Builder locationBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pickme.events.driver.driver_location_changed.Body.Builder other) {
      super(other);
      ...
      if (other.hasLocationBuilder()) {
        this.locationBuilder = com.pickme.events.driver.driver_location_changed.Location.newBuilder(other.getLocationBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pickme.events.driver.driver_location_changed.Body other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.driver_id)) {
        this.driver_id = data().deepCopy(fields()[0].schema(), other.driver_id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.driver.driver_location_changed.Body.Builder setDriverId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.driver.driver_location_changed.Body.Builder clearDriverId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.driver.driver_location_changed.Body.Builder setLocation(com.pickme.events.driver.driver_location_changed.Location value) {
     ...
     * @return This builder.
     */
    public com.pickme.events.driver.driver_location_changed.Location.Builder getLocationBuilder() {
      if (locationBuilder == null) {
        if (hasLocation()) {
          setLocationBuilder(com.pickme.events.driver.driver_location_changed.Location.newBuilder(location));
        } else {
          setLocationBuilder(com.pickme.events.driver.driver_location_changed.Location.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.pickme.events.driver.driver_location_changed.Body.Builder setLocationBuilder(com.pickme.events.driver.driver_location_changed.Location.Builder value) {
      clearLocation();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pickme.events.driver.driver_location_changed.Body.Builder clearLocation() {
      location = null;
    ...
    public Body build() {
      try {
        ...
        if (locationBuilder != null) {
          ...
          record.location = fieldSetFlags()[1] ? this.location : (com.pickme.events.driver.driver_location_changed.Location) defaultValue(fields()[1]);
        }
        return record;
